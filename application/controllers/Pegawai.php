...
class Pegawai extends CI_Controller {
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('nama', 'Nama', 'trim|required|min_length[3]|max_length[8]|alpha');
		$this->form_validation->set_rules('nip', 'Nip', 'trim|required|min_length[3]|max_length[18]|numeric');
		$this->form_validation->set_rules('tanggalLahir', 'Tanggal Lahir', 'trim|required');
		$this->form_validation->set_rules('alamat', 'Alamat', 'trim|required|min_length[3]|max_length[50]|alpha');
